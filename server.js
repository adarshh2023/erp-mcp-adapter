...
async function erp(path, method = "GET", body) {
  ...
  const res = await fetch(url, {
    ...
    headers: {
      Authorization:
        "Bearer eyJhbGciOiJIUzUxMiJ9..COE1pKR-0qb4Xm4hfxQDGraNT49UoeOfE43cHwrkLQ5H57hBIvYxQ2HXZ4jYnV4SO3poJffdFfjoE3iTuZgd3Q",
