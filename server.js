...
async function erp(path, method = "GET", body) {
  ...
  const res = await fetch(url, {
    ...
    headers: {
      Authorization:
        "Bearer eyJhbGciOiJIUzUxMiJ9..cSFmvLbA4sUb_WSQLAWFHTHlxLLrQwWiHvwCtc5TZzc8DpeUR-o6LmCqlucOOSr1PMIsGzfclGYh1nC0cwrLQg",
