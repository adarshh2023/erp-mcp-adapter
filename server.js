...
async function erp(path, method = "GET", body) {
  ...
  const res = await fetch(url, {
    ...
    headers: {
      Authorization:
        "Bearer eyJhbGciOiJIUzUxMiJ9..PpeXP5POqttqOXpb4E13VbtuhTwNxcVMd17vPp-cGW7ISKWc7nFOUeWwdNyAWTKnjzNkcTHYpC8epTlHgEQzow",
