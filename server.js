...
async function erp(path, method = "GET", body) {
  ...
  const res = await fetch(url, {
    ...
    headers: {
      Authorization:
        "Bearer eyJhbGciOiJIUzUxMiJ9..6aCIwjBwrkp79Ue2GmUAiyEbDjL2Z03Eg4vS4IEEbd1z7tWtshzsUP2wJBI9BP9WISIOoFh9ON26pydM0ylw6A",
