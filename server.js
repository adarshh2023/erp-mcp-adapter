...
async function erp(path, method = "GET", body) {
  ...
  const res = await fetch(url, {
    ...
    headers: {
      Authorization:
        "Bearer eyJhbGciOiJIUzUxMiJ9..Xb2-DWhTRXcnlnPNWACyN6mLP-ZPqTRJOGjbavobDzbiODurVwtsi5FDzubxyPz1u3gvQMli-bA8Gh68uMG53Q",
